...
        $eventListHTML .= '<li class="sidebar_list-item sidebar_list-item--complete">Events</li>'; 
        $i=0; 
        while($row = $result->fetch_assoc()){ $i++; 
            $eventListHTML .= '<li class="sidebar_list-item"><span class="list-item_time">'.$i.'.</span>'.$row['title'].'</li>'; 
        } 
        $eventListHTML .= '</ul>'; 
    } 
    echo $eventListHTML; 
